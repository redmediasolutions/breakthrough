      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(color: const Color(0xFF1E2140), borderRadius: BorderRadius.circular(12)),
              child: TextField(
            ...
            Center(
              child: Row(
                ...
                children: [
                  const Text("Already have an account? ", style: TextStyle(color: Color(0xFF8A93BE), fontWeight: FontWeight.w600, fontSize: 15)),
                  GestureDetector(
                    onTap: () => context.pushNamed('loginpage'),
                    child: const Text("Login", style: TextStyle(color: Color(0xFF1437EF), fontWeight: FontWeight.w600, fontSize: 15)),
                  ),
                ],
              ),
            ),
            ...
            const Center(
              child: Text.rich(
                TextSpan(
                  ...
                  style: TextStyle(color: Color(0xFF42517A), fontSize: 9, fontWeight: FontWeight.bold, height: 1.4),
                  children: [
                    TextSpan(
                      text: "TERMS OF SERVICE & PRIVACY POLICY.",
                      style: TextStyle(decoration: TextDecoration.underline, decorationColor: Color(0xFF8A93BE)),
                    ),
                  ],
                ),
